---
title: "Running a numerical experimental design"
data: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Running a numerical experimental design}
...
# Running a numerical experimental design
...
one simulation to anoter). The dataframe must also contain columns to store simulation outputs.  
...
*See tutorial on how to [run a simple simulation](run_simple_simul.html) for details on the different functions.* 
```{r, eval=FALSE}
for (i in 1:n){  
